...
@DatabaseTable(tableName="ano_semestre")
public class AnoSemestre extends Entidade implements KvmSerializable, Serializable {
	...
	public AnoSemestreVisao getAnoSemestreVisao(){
	    return new AnoSemestreVisao(id,descricao);
    }
