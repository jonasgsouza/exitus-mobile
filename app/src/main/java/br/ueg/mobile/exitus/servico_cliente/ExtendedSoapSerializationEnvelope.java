...
import br.ueg.mobile.exitus.modelo.Entidade;
...
public class ExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://servico.exitus.ueg.br/^^agendarSincronizacaoFrequencia",AgendarSincronizacaoFrequencia.class);
        classNames.put("http://servico.exitus.ueg.br/^^atualizarFrequencia",AtualizarFrequencia.class);
        classNames.put("http://servico.exitus.ueg.br/^^retorno", Retorno.class);
        classNames.put("http://servico.exitus.ueg.br/^^professorDTO", Professor.class);
        classNames.put("http://servico.exitus.ueg.br/^^anoSemestre",AnoSemestre.class);
        classNames.put("http://servico.exitus.ueg.br/^^entidade",Entidade.class);
        classNames.put("http://servico.exitus.ueg.br/^^ofertaDisciplinaProfessor",OfertaDisciplinaProfessor.class);
        classNames.put("http://servico.exitus.ueg.br/^^ofertaDisciplina",OfertaDisciplina.class);
        classNames.put("http://servico.exitus.ueg.br/^^disciplina",Disciplina.class);
        classNames.put("http://servico.exitus.ueg.br/^^ofertaCurso",OfertaCurso.class);
        classNames.put("http://servico.exitus.ueg.br/^^campus",Campus.class);
        classNames.put("http://servico.exitus.ueg.br/^^curso",Curso.class);
        classNames.put("http://servico.exitus.ueg.br/^^matriz",Matriz.class);
        classNames.put("http://servico.exitus.ueg.br/^^ofertaDisciplinaAluno",OfertaDisciplinaAluno.class);
        classNames.put("http://servico.exitus.ueg.br/^^aluno",AlunoVisao.class);
        classNames.put("http://servico.exitus.ueg.br/^^frequencia",Frequencia.class);
        classNames.put("http://servico.exitus.ueg.br/^^frequenciaAluno",FrequenciaAluno.class);
    }
